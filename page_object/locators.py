...
class Locators:
  ...
  BTN_CREATE_1                 = "//img[@alt='Create']"
  BTN_CREATE_2                 = "//span[text()='Create']"
  BTN_STOP_1                   = "//img[@alt='Stop']"
  BTN_STOP_2                   = "//span[text()='Stop']"
  BTN_RESTART_1                = "//img[@alt='Restart']"
  BTN_RESTART_2                = "//span[text()='Restart']"
