...
class SiteCreation(unittest.TestCase):
    ...
    def test_create_new_site_with_acceptable_name(self):
        ...
        left_menu.delete_site_from_global_site_view_tree(sitename)
        self.assertFalse(left_menu.check_site_is_in_global_site_view_tree(sitename))
        self.logger.info("TEST PASSED")
    ...
    def test_cancel_creating_site(self):
        ...
        self.assertTrue(site_name_popup.check_popup_is_not_present())
        self.logger.info("TEST PASSED")
    ...
    def test_create_site_with_duplicated_name(self):
        ...
        self.assertTrue(error_popup.check_popup_is_not_present())
        self.assertTrue(site_name_popup.check_popup_is_present())
    ...
    def test_create_site_with_fifty_one_symbols(self):
        ...
        left_menu.delete_site_from_global_site_view_tree(fifty_symbols_name)
        self.assertFalse(left_menu.check_site_is_in_global_site_view_tree(fifty_symbols_name))
        self.logger.info("TEST PASSED")
...
class SiteConfigurationSiteTab((unittest.TestCase)):
    ...
    def test_configuration_popup_change_site_name(self):
        ...
        configuration_popup.click_system_button_close()
        self.assertFalse(configuration_popup.check_popup_is_present())
        left_menu.delete_site_from_global_site_view_tree(sitename + modifed)
        self.assertFalse(left_menu.check_site_is_in_global_site_view_tree(sitename + modifed))
        left_menu.delete_site_if_exists(sitename)
        self.assertFalse(left_menu.check_site_is_in_global_site_view_tree(sitename))
        print ("TEST PASSED" + "\n")
...
class MainPageHelpLinks(unittest.TestCase):
    ...
    #     super(MainPageHelpLinks, self).__init__(self.log_name)
    #     self.log_name = "help_link_test"
    ...
    def test_A_help_link_on_dynamically_managed_screen(self):
        ...
        left_menu.open_menu_administration()
        self.assertTrue(left_menu.check_menu_administration_is_opened())
        left_menu.expand_endpoint_management_tree()
        self.assertTrue(left_menu.check_dynamically_managed_label_is_present())
    ...
    def test_A_help_link_on_excluded_devices_screen(self):
        ...
        self.assertTrue(left_menu.check_menu_administration_is_opened())
        left_menu.expand_endpoint_management_tree()
        self.assertTrue(left_menu.check_excluded_devices_label_is_present())
    ...
    def test_A_help_link_on_infrastructure_screen(self):
        ...
        self.assertTrue(left_menu.check_menu_administration_is_opened())
        left_menu.expand_endpoint_management_tree()
        self.assertTrue(left_menu.check_infrastructure_label_is_present())
    ...
    def test_A_help_link_on_site_config_popup(self):
        ...
        self.assertTrue(left_menu.check_menu_administration_is_opened())
        left_menu.click_site_management_label()
        self.assertTrue(ribbon_bar.check_box_config_is_present())
    ...
    def test_A_help_link_on_column_set_designer_popup(self):
        ...
        self.assertTrue(left_menu.check_menu_administration_is_opened())
        left_menu.click_column_sets_label()
        self.assertTrue(ribbon_bar.check_box_column_sets_is_present())
    ...
    def test_A_help_link_on_edit_user_popup(self):
        self.logger.info("TC#0000: Check help link on Edit User popup (Administration)")
        expected_header = "Create" #IS NOT CORRECT
        left_menu = LeftMenuAdministration(self.driver)
        ribbon_bar = RibbonBar(self.driver)
        ...
        self.assertTrue(ribbon_bar.check_box_users_is_present())
        ribbon_bar.click_button_add()
        self.assertTrue(edit_user_popup.check_popup_is_present())
    ...
    def test_A_help_link_on_inventory_configuration_popup(self):
        ...
        self.assertTrue(left_menu.check_menu_administration_is_opened())
        left_menu.click_inventory_scan_configuration_label()
        self.assertTrue(ribbon_bar.check_box_inventory_is_present())
        ribbon_bar.click_button_create()
        self.assertTrue(inventory_configuration_popup.check_popup_is_present())
    ...
    def test_A_help_link_on_inventory_force_update_popup(self):
        ...
        left_menu.click_inventory_scan_configuration_label()
        self.assertTrue(ribbon_bar.check_box_inventory_is_present())
        self.assertTrue(inventory_configuration_screen.check_inventory_is_present("Full Scan"))
        inventory_configuration_screen.select_full_scan_inventory_in_table()
        self.assertTrue(ribbon_bar.check_button_force_update_is_unabled())
        ribbon_bar.click_button_force_update()
        self.assertTrue(inventory_force_update_popup.check_popup_is_present())
    ...
    def test_A_help_link_on_maintenance_window_popup(self):
        ...
        self.assertTrue(left_menu.check_menu_administration_is_opened())
        left_menu.click_maintenance_windows_label()
        self.assertTrue(ribbon_bar.check_maintenance_windows_box_is_present())
        ribbon_bar.click_button_add()
        self.assertTrue(maintenance_window_popup.check_popup_is_present())
    ...
    def test_D_help_link_on_configuration_popup(self):
        ...
        left_menu.open_menu_devices()
        self.assertTrue(left_menu.check_menu_devices_is_opened())
        left_menu.open_global_site_view_tree()
        self.assertTrue(ribbon_bar.check_button_config_is_present())
        ribbon_bar.click_button_config()
        self.assertTrue(configuration_popup.check_popup_is_present())
    ...
    def test_D_help_link_on_edit_folder_popup(self):
        ...
        self.assertTrue(left_menu.check_folder_is_in_groups_tree(name))
        left_menu.click_group_in_groups_tree(name)
    ...
    def test_D_help_link_on_move_device_popup(self):
        ...
        devices_screen.select_device_in_table(device)
        ribbon_bar.open_tab_devices()
        self.assertTrue(ribbon_bar.check_box_site_management_is_present())
    ...
    def test_D_help_link_on_file_explorer_popup(self):
        ...
        self.assertTrue(ribbon_bar.check_box_computer_tools_is_present())
    ...
    def test_S_help_link_on_applications_screen(self):
        ...
        left_menu.open_menu_software_and_patch_manager()
        self.assertTrue(left_menu.check_applications_label_is_present())
        left_menu.click_applications_label()
        self.assertTrue(applications_screen.check_screen_is_present())
    ...
    def test_S_help_link_on_patch_manager_screen(self):
        ...
        left_menu.open_menu_software_and_patch_manager()
        self.assertTrue(left_menu.check_patch_manager_label_is_present())
        left_menu.click_patch_manager_label()
        self.assertTrue(patch_manager_screen.check_screen_is_present())
    ...
    def test_S_help_link_on_manage_install_media_screen(self):
        ...
        left_menu.open_menu_software_and_patch_manager()
        self.assertTrue(left_menu.check_patch_manager_label_is_present())
        left_menu.expand_media_management_tree()
        self.assertTrue(left_menu.check_my_patches_label_is_present())
        left_menu.click_my_patches_label()
        self.assertTrue(manage_install_media_screen.check_screen_is_present())
    ...
    def test_S_help_link_on_create_application_wizard_popup(self):
        ...
        self.assertTrue(left_menu.check_applications_label_is_present())
        left_menu.click_applications_label()
        self.assertTrue(ribbon_bar.check_box_applications_is_present())
        ribbon_bar.click_button_create()
        self.assertTrue(create_application_wizard_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_installers_popup(self):
        ...
        self.assertTrue(ribbon_bar.check_box_applications_is_present())
        ribbon_bar.click_button_create()
        self.assertTrue(create_application_popup.check_popup_is_present())
        create_application_popup.click_button_choose_installer_on_sever()
        self.assertTrue(installers_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_create_update_wizard_popup(self):
        ...
        self.assertTrue(left_menu.check_applications_label_is_present())
        left_menu.click_patch_manager_label()
        self.assertTrue(ribbon_bar.check_box_updates_is_present())
        ribbon_bar.click_button_create()
        self.assertTrue(create_update_wizard_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_advanced_editor_popup(self):
        ...
        self.assertTrue(advanced_editor_popup.check_popup_is_present())
        advanced_editor_popup.click_pre_requisites_label()
        self.assertTrue(advanced_editor_popup.check_tab_pre_requisites_is_present())
    ...
    def test_S_help_link_on_pre_requisites_popup(self):
        ...
        self.assertTrue(pre_requisites_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_select_install_media_popup(self):
        ...
        self.assertTrue(advanced_editor_popup.check_tab_components_is_present())
        advanced_editor_popup.click_button_add()
        self.assertTrue(select_install_media_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_component_popup(self):
        ...
        self.assertTrue(component_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_filters_popup(self):
        ...
        self.assertTrue(filters_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_existing_software_update_detection_popup(self):
        ...
        self.assertTrue(existing_software_update_detection_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_deployments_popup(self):
        ...
        self.assertTrue(deployments_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_install_commands_popup(self):
        ...
        self.assertTrue(deployments_popup.check_tab_install_commands_is_present())
        deployments_popup.click_button_edit_commands()
        self.assertTrue(install_commands_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_uninstall_commands_popup(self):
        ...
        self.assertTrue(deployments_popup.check_tab_uninstall_commands_is_present())
        deployments_popup.click_button_edit_commands()
        self.assertTrue(uninstall_commands_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_superseding_patches_popup(self):
        ...
        self.assertTrue(superseding_patches_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_select_superseding_patches_popup(self):
        ...
        self.assertTrue(select_superseding_patches_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_create_patch_group_popup(self):
        ...
        left_menu.open_menu_software_and_patch_manager()
        self.assertTrue(left_menu.check_applications_label_is_present())
        left_menu.expand_patch_manager_tree()
        self.assertTrue(left_menu.check_by_group_label_is_present())
        left_menu.click_by_group_label()
        self.assertTrue(ribbon_bar.check_box_patch_groups_is_present())
        ribbon_bar.click_button_create_group()
        self.assertTrue(create_patch_group_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_select_patches_popup(self):
        ...
        self.assertTrue(select_patches_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_edit_patch_group_popup(self):
        ...
        self.assertTrue(left_menu.check_group_is_in_by_group_tree(name))
        left_menu.click_group_in_by_group_tree(name)
        ribbon_bar.click_button_edit_group()
        self.assertTrue(edit_patch_group_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_query_designer_popup(self):
        ...
        self.assertTrue(ribbon_bar.check_box_patch_query_rules_is_present())
        ribbon_bar.click_button_create_query()
        self.assertTrue(query_designer.check_popup_is_present())
    ...
    def test_S_help_link_on_patch_manager_settings_popup(self):
        ...
        self.assertTrue(ribbon_bar.check_box_updates_is_present())
        ribbon_bar.open_tab_advanced()
        self.assertTrue(ribbon_bar.check_tab_advanced_is_present())
        ribbon_bar.click_button_settings()
        self.assertTrue(patch_manager_settings_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_management_tree_popup(self):
        self.logger.info("TC#0000: Check help link on Management Tree popup")
        expected_header = "Management Tree"
        left_menu = LeftMenuSoftwareAndPatchManager(self.driver)
        patch_manager_screen = PatchMangerScreen(self.driver)
        management_tree_popup = ManagementTreePopup(self.driver)
        left_menu.open_menu_software_and_patch_manager()
        self.assertTrue(left_menu.check_applications_label_is_present())
        left_menu.click_patch_manager_label()
        self.assertTrue(patch_manager_screen.check_screen_is_present())
        patch_manager_screen.click_at_filter_field()
        self.assertTrue(management_tree_popup.check_popup_is_present())
        management_tree_popup.click_icon_help()
        actual_header = management_tree_popup._get_help_frame_header()
        self.assertEqual(
            expected_header, actual_header, management_tree_popup._get_log_for_help_link(expected_header))
        self.logger.info("TEST PASSED")
    ...
    def test_S_help_link_on_scan_schedule_popup(self):
        ...
        self.assertTrue(left_menu.check_applications_label_is_present())
        left_menu.click_patch_manager_label()
        self.assertTrue(ribbon_bar.check_box_move_to_is_present())
        ribbon_bar.open_tab_advanced()
        self.assertTrue(ribbon_bar.check_tab_advanced_is_present())
        ribbon_bar.click_button_to_be_checked()
        self.assertTrue(scan_schedule_popup.check_popup_is_present())
    ...
    def test_S_help_link_on_import_software_update_definition_popup(self):
        ...
        self.assertTrue(left_menu.check_applications_label_is_present())
        left_menu.click_patch_manager_label()
        self.assertTrue(ribbon_bar.check_box_import_is_present())
        ribbon_bar.click_button_import()
        self.assertTrue(import_software_update_definition_popup.check_popup_is_present())
    ...
    def test_T_help_link_on_discovery_tasks_screen(self):
        ...
        left_menu.open_menu_tasks()
        self.assertTrue(left_menu.check_menu_tasks_is_opened())
        left_menu.expand_scheduled_tasks_tree()
        self.assertTrue(left_menu.check_discover_label_is_present())
    ...
    def test_T_help_link_on_software_deployments_screen(self):
        ...
        self.assertTrue(left_menu.check_menu_tasks_is_opened())
        left_menu.expand_scheduled_tasks_tree()
        self.assertTrue(left_menu.check_software_deployment_label_is_present())
    ...
    def test_T_help_link_on_discover_devices_popup(self):
        ...
        self.assertTrue(left_menu.check_discover_label_is_present())
        left_menu.click_discover_label()
        self.assertTrue(ribbon_bar.check_box_discovery_task_is_present())
        ribbon_bar.click_button_create()
        self.assertTrue(discover_devices_popup.check_popup_is_present())
        discover_devices_popup.click_icon_help()
        actual_header = discover_devices_popup._get_help_frame_header()
    ...
    def test_T_help_link_on_software_deployment_popup(self):
        ...
        self.assertTrue(left_menu.check_software_deployment_label_is_present())
        left_menu.click_software_deployment_label()
        self.assertTrue(ribbon_bar.check_box_software_deployment_is_present())
        ribbon_bar.click_button_create()
        self.assertTrue(software_deployment_popup.check_popup_is_present())
    ...
    def test_T_help_link_on_patch_manager_scanning_popup(self):
        ...
        self.assertTrue(left_menu.check_patch_manager_label_is_present())
        left_menu.click_patch_manager_label()
        self.assertTrue(ribbon_bar.check_box_patch_manager_is_present())
        ribbon_bar.click_button_scan()
        self.assertTrue(patch_manager_scanning_popup.check_popup_is_present())
    ...
    def test_T_help_link_on_deploy_software_updates_popup(self):
        ...
        self.assertTrue(deploy_software_updates_popup.check_popup_is_present())
